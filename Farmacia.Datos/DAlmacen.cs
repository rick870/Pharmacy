    ...
    public class DAlmacen
    {
        ...
        public DataTable Listado(string texto)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("almacen_listar", cn);
        ...
        public string Guardar(int opcion, Almacen obj)
        {
            string Rpta = "";
            ...
            try
            {
                ...
                SqlCommand cm = new SqlCommand("almacen_guardar", con);
                cm.CommandType = CommandType.StoredProcedure;
                cm.Parameters.Add("@opcion", SqlDbType.Int).Value = opcion;
                cm.Parameters.Add("@id_al", SqlDbType.Int).Value = obj.Id_al;
                cm.Parameters.Add("@descripcion_al", SqlDbType.VarChar).Value = obj.Descripcion_al;
        ...
        public string Eliminar(int id_al)
        {
            string Rpta = "";
            SqlConnection con = new SqlConnection();
            try
            {
                con = Conexion.getInstancia().CrearConexion();
                SqlCommand cm = new SqlCommand("almacen_eliminar", con);
                cm.CommandType = CommandType.StoredProcedure;
                cm.Parameters.Add("@id_al", SqlDbType.Int).Value = id_al;
                con.Open();
