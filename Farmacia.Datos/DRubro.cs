    ...
    public class DRubro
    {
        ...
        public DataTable Listado(string texto)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("rubro_listar", cn);
        ...
        public string Guardar(int opcion, Rubro obj)
        {
            string Rpta = "";
            ...
            try
            {
                ...
                SqlCommand cm = new SqlCommand("rubro_guardar", con);
                cm.CommandType = CommandType.StoredProcedure;
                cm.Parameters.Add("@opcion", SqlDbType.Int).Value = opcion;
                cm.Parameters.Add("@id_ru", SqlDbType.Int).Value = obj.Id_ru;
                cm.Parameters.Add("@descripcion_ru", SqlDbType.VarChar).Value = obj.Descripcion_ru;
        ...
        public string Eliminar(int id_ru)
        {
            string Rpta = "";
            SqlConnection con = new SqlConnection();
            try
            {
                con = Conexion.getInstancia().CrearConexion();
                SqlCommand cm = new SqlCommand("rubro_eliminar", con);
                cm.CommandType = CommandType.StoredProcedure;
                cm.Parameters.Add("@id_ru", SqlDbType.Int).Value = id_ru;
                con.Open();
