    ...
    public class DMarca
    {
        ...
        public DataTable Listado(string texto)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("marca_listar", cn);
        ...
        public string Guardar(int opcion, Marca obj)
        {
            string Rpta = "";
            ...
            try
            {
                ...
                SqlCommand cm = new SqlCommand("marca_guardar", con);
                cm.CommandType = CommandType.StoredProcedure;
                cm.Parameters.Add("@opcion", SqlDbType.Int).Value = opcion;
                cm.Parameters.Add("@id_ma", SqlDbType.Int).Value = obj.Id_ma;
                cm.Parameters.Add("@descripcion_ma", SqlDbType.VarChar).Value = obj.Descripcion_ma;
        ...
        public string Eliminar(int id_ma)
        {
            string Rpta = "";
            SqlConnection con = new SqlConnection();
            try
            {
                con = Conexion.getInstancia().CrearConexion();
                SqlCommand cm = new SqlCommand("marca_eliminar", con);
                cm.CommandType = CommandType.StoredProcedure;
                cm.Parameters.Add("@id_ma", SqlDbType.Int).Value = id_ma;
                con.Open();
