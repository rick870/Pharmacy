    ...
    public class DDepartamento
    {
        ...
        public DataTable Listado(string texto)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("departamento_listar", cn);
        ...
        public string Guardar(int opcion, Departamento obj)
        {
            string Rpta = "";
            ...
            try
            {
                ...
                SqlCommand cm = new SqlCommand("departamento_guardar", con);
                cm.CommandType = CommandType.StoredProcedure;
                cm.Parameters.Add("@opcion", SqlDbType.Int).Value = opcion;
                cm.Parameters.Add("@id_de", SqlDbType.Int).Value = obj.Id_de;
                cm.Parameters.Add("@descripcion_de", SqlDbType.VarChar).Value = obj.Descripcion_de;
        ...
        public string Eliminar(int id_de)
        {
            string Rpta = "";
            SqlConnection con = new SqlConnection();
            try
            {
                con = Conexion.getInstancia().CrearConexion();
                SqlCommand cm = new SqlCommand("departamento_eliminar", con);
                cm.CommandType = CommandType.StoredProcedure;
                cm.Parameters.Add("@id_de", SqlDbType.Int).Value = id_de;
                con.Open();
