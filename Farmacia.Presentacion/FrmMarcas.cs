...
namespace Farmacia.Presentacion
{
    public partial class FrmMarcas : Form
    {
        ...
        private void Formato()
        {
            ...
            Dgprincipal.Columns[1].HeaderText = "MARCA";
        }
        private void Listado(string texto)
        {
            try
            {
                Dgprincipal.DataSource = NMarca.Listado(texto);
                this.Formato();
            }
            catch (Exception ex)
            {
        ...
        {
            if (string.IsNullOrEmpty(Convert.ToString(Dgprincipal.CurrentRow.Cells["id_ma"].Value)))
            {
            ...
            else
            {
                ...
                Txtdescripcion.Text = Convert.ToString(Dgprincipal.CurrentRow.Cells["descripcion_ma"].Value);
            }
        }
        ...
        private void Btnguardar_Click(object sender, EventArgs e)
        {
            ...
            else //Se procedera a insertar
            {
                ...
                obj.Descripcion_ma = Txtdescripcion.Text.Trim();
                Rpta = NMarca.Guardar(opcion, obj);
                if (Rpta == "OK")
                {
                    this.Listado("%");
        ...
        private void Btneliminar_Click(object sender, EventArgs e)
        {
            ...
            else //Se procedera a eliminar
            {
                ...
                if (opc == DialogResult.Yes)
                {
                    string Rpta = "";
                    this.id_ma = Convert.ToInt32(Dgprincipal.CurrentRow.Cells["id_ma"].Value);
                    Rpta = NMarca.Eliminar(this.id_ma);
                    if (Rpta.Equals("OK"))
                    {
                        this.Listado("%");
                        this.id_ma = 0;
        ...
        {
           Reportes.FrmRpt_Marcas obj = new Reportes.FrmRpt_Marcas();
