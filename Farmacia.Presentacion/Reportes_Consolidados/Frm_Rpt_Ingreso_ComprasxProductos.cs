...
namespace Farmacia.Presentacion.Reportes_Consolidados
{
    public partial class Frm_Rpt_Ingreso_ComprasxProductos : Form
    {
        ...
        {
            this.reporte_Ingresos_ComprasxProductosTableAdapter.Fill(this.dataSet_Reportes_Consolidados.Reporte_Ingresos_ComprasxProductos, Fecha_ini: Convert.ToDateTime(txt_p1.Text), Fecha_fin: Convert.ToDateTime(txt_p2.Text));
